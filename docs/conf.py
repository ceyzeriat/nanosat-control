...
import sys
import os
from ..ctrl import __version__, __major__, __minor__, __micro__
import time

package_name = u'picsat'
package_name_cap = u'PicSat'
description = u'Controlling the Satellite from Home'
