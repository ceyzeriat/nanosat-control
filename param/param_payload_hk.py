...
O_KEYS = [  dict(name='temp4', start=208, l=16, disp="temp4",
            ...
            dict(name='acqmode', start=256, l=8, disp="acqmode",
                    verbose="acqmode",
                    fctunpack=bincore.bin2int, fctpack=bincore.int2bin),
            dict(name='beacon_flag', start=266, l=1, disp="beacon_flag",
                    verbose="beacon_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin),
            dict(name='tec_flag', start=267, l=1, disp="tec_flag",
                    verbose="tec_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin),
            dict(name='sensors_flag', start=268, l=1, disp="sensors_flag",
                    verbose="sensors_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin),
            dict(name='hv_flag', start=269, l=1, disp="hv_flag",
                    verbose="hv_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin),
            dict(name='dac_flag', start=270, l=1, disp="dac_flag",
                    verbose="dac_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin),
            dict(name='interrupt_flag', start=271, l=1, disp="interrupt_flag",
                    verbose="interrupt_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin),
            dict(name='diode_flag', start=272, l=1, disp="diode_flag",
                    verbose="diode_flag",
                    fctunpack=bincore.bin2bool, fctpack=bincore.bool2bin)
            ]
