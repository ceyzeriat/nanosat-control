...
#PAYLOAD BOOTLOADER
                245: CCSDSTrousseau([CCSDSKey(name='version', start=0, l=255, fctunpack=bincore.bin2txt, fctpack=bincore.txt2bin, verbose='none', disp='version', pad = False)], octets=True),
