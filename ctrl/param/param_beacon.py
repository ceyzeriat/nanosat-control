...
from ..ccsds import CCSDSKey


DATABEACON = [  CCSDSKey(name='satMode', start=456, l=8, fctunpack=core.bin2int),
                ...
                CCSDSKey(name='hkErrorFlags', start=0, l=16, fctunpack=core.bin2int)]
