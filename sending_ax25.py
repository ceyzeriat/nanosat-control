...
import aprs, socket, kiss

frame = aprs.Frame()
#frame.source = aprs.Callsign(b'W2GMD-14')
frame.source = aprs.Callsign(b'\xE0\x60')
#frame.destination = aprs.Callsign(b'PYKISS')
frame.destination = aprs.Callsign(b'\x82\x98\x98')
#frame.path = [aprs.Callsign(b'WIDE1-1')]
frame.path = []
